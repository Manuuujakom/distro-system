...
<nav id="sidebar" class="group fixed left-0 top-0 h-screen z-40 w-64 -translate-x-full md:translate-x-0 transition-all duration-300 ease-in-out flex flex-col text-slate-200 border-r border-white/5" style="background-color: var(--color-sidebar);">
    ...
    <div class="flex-1 px-2 space-y-1 overflow-y-auto overflow-x-hidden scrollbar-none">
        <a href="#" data-page="dashboard" class="flex items-center px-4 py-3 rounded-lg mx-2 my-0.5 transition-all border-l-2 border-transparent hover:bg-white/10 hover:text-white group/link">
        ...
        <a href="#" data-page="purchases" class="flex items-center px-4 py-3 rounded-lg mx-2 my-0.5 transition-all border-l-2 border-transparent hover:bg-white/10 hover:text-white group/link">
        ...
        <a href="#" data-page="stock" class="flex items-center px-4 py-3 rounded-lg mx-2 my-0.5 transition-all border-l-2 border-transparent hover:bg-white/10 hover:text-white group/link">
        ...
        <a href="#" data-page="sales" class="flex items-center px-4 py-3 rounded-lg mx-2 my-0.5 transition-all border-l-2 border-transparent hover:bg-white/10 hover:text-white group/link">
        ...
        <a href="#" data-page="pos" class="flex items-center px-4 py-3 rounded-lg mx-2 my-0.5 transition-all border-l-2 border-transparent hover:bg-white/10 hover:text-white group/link">
        ...
        <a href="#" data-page="reports" class="flex items-center px-4 py-3 rounded-lg mx-2 my-0.5 transition-all border-l-2 border-transparent hover:bg-white/10 hover:text-white group/link">
        ...
        <a href="#" data-page="accounting" class="flex items-center px-4 py-3 rounded-lg mx-2 my-0.5 transition-all border-l-2 border-transparent hover:bg-white/10 hover:text-white group/link">
        ...
        <a href="#" data-page="logistics" class="flex items-center px-4 py-3 rounded-lg mx-2 my-0.5 transition-all border-l-2 border-transparent hover:bg-white/10 hover:text-white group/link">
    ...
    <!-- Bottom Section -->
    <div class="mt-auto border-t border-white/10 p-2 space-y-1">
        <!-- User Information -->
        ...
        <!-- Theme Toggle -->
        <button id="theme-toggle" class="w-full flex items-center px-3 py-2 rounded-lg hover:bg-white/10 transition-colors text-slate-300 hover:text-white">
            ...
            <span class="theme-label nav-label ml-3 text-sm font-medium whitespace-nowrap transition-all duration-300 opacity-100 group-[.collapsed]:opacity-0 group-[.collapsed]:w-0">Dark Mode</span>
        </button>

        <!-- Logout -->
        <a href="#" class="w-full flex items-center px-3 py-2 rounded-lg hover:bg-red-500/20 text-slate-300 hover:text-red-400 transition-colors">
