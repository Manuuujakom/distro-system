                ...
                <form method="post" onsubmit="return false;" class="space-y-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" placeholder="Enter your username" class="block w-full pl-11 pr-4 py-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all outline-none text-sm">
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input id="password-input" type="password" placeholder="••••••••" class="block w-full pl-11 pr-12 py-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-4 focus:ring-primary/10 focus:border-primary transition-all outline-none text-sm">
